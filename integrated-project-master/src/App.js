...
// import ChatVox from './components/Chat'
    ...
    <div className="App">
        <Router>
          <Routes>
            ...
            <Route path='/welcome-chat/chatroom' element={<ChatBox/>} />
            </Routes>
        </Router>
    </div>  
  );
...
//       audioStatus: Sound.status.STOPPED, //initial status of sound
//       audioNames: ['rain', 'forest', 'park', 'stream', 'waves'], //sound options
...
//     })
//   }
//   /* if status of sound is paused set the state to set the button to pauseButton and audio to playing
//   else if the audio is playing set the button to playbutton and audio status to pause
//   */
//   playPause() { 
//     if (
...
//   audioSelect(audioName) { //switching to different audio options
//     switch (audioName) {
